...
public class GrilleNavaleOld {
	...
	*/
	...
	// 3.1 : Constructeurs
	public GrilleNavaleOld(int taille, int[] taillesNavires) {
	...
	public GrilleNavaleOld(int taille) {
...
//	}
	...
	public static void main(String[] args) {
		...
		GrilleNavaleOld plateau = new GrilleNavaleOld(8);
